      ...
      projects: [
        {
          ...
          techs: [
            ...
            "<u>Laravelの認証</u>: Auth, Guard",
            "<u>sessionStorage</u>",
            "<u>Eloquent ORM + Postgres</u>: Foreign Key, one-to-manyなどのrelationships, $appendsアクセサによるカラム値の自動生成",
            "<u>Cypress</u>によるテスト自動化",
            "<u>AWS EC2</u>へのアプリ展開"
          ],
          achvs: [
            "初めての本格的なWeb App構築でした。DBの設定からフロントエンドとバックエンドの連携までやる中で、大量の発見がありました。",
            "Axiosによって頻繁にDBにアクセスするため、<u>async/awaitなどの非同期処理と、v-ifやcomputedなどを使ってレンダリングのタイミング管理</u>が重要になり、苦労しました。",
            ...
            "<u>ドキュメンテーション</u>を整備しました。自分にとってはわかりきっている機能やコードの構造も、他人にわかるよう説明するのは想像以上に大変でした。",
            "業界のスタンダードになっているAWSに触れ、本格的なエンジニアに一歩近づけたと思います。"
          ]
        },
        ...
        },
        {
          ...
          techs: [
            ...
            "このBotのバス情報の機能には欠点があり、市営バスの時刻表データが手に入らないため「バスがいつ発車するのか」がわからないことです。<u>結局は情報の入手難度が、データ分析のネック</u>になってしまっています。"
          ],
          achvs: [
