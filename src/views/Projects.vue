      ...
      <v-card-subtitle class="subtitle-1">
        <ul>
          <li>
            ...
            プログラマになるための勉強の題材として私がつくったものを、一部ご紹介いたします。
          </li>
          <li>
            「自分が実際に使いたくなるツールを制作しよう」という点に主眼に置きました。このためプロジェクトの中身は様々です。
          </li>
          <li>
            制作物それぞれにデモページを設けましたので、ぜひご覧ください。なお、各プロジェクトのGitHubページでは更に詳しく説明しています。
          </li>
        </ul>
      </v-card-subtitle>
    </v-card>
      ...
      projects: [
        {
          ...
          funcs: [
            "<b>寮紹介：</b>　入寮希望者向けに、寮の概要などを説明します。",
            "<b>寮生基本情報の管理</b>： 寮生の入寮日、退寮日、メールアドレスなどの個人情報を管理します。",
            "居室の管理：　居室の故障箇所や居住可否などを管理する機能です。",
            "寮費支払の管理： 月々の寮費・月々の報酬と罰金・支払状況（誰が支払いを完了したのか？誰が滞納しているのか？）を詳細に把握する機能です。",
            "寮費計算の管理：　役職を割り当てられた人間や特別な仕事をこなした寮生には報酬が与えられ、掃除をサボるなどした寮生には罰金が加わります。この個別の細かい賞罰設定を、機能として実装しました。",
            "寮生の役職期間の管理：　役職のある寮生の任期がいつからいつまでなのかを記録として残します。",
            "ログイン： LaravelのAuthを利用し閲覧や編集の権限を管理。"
          ],
          funcImg: "",
          techs: [
            "Vue",
        ...
        },
        {
          ...
          funcs: [
            ...
            "「勝者や引き分けを表示する」「ゲーム勝敗が確定した場合にはそれ以降のクリックを受け付けない」など、詳細も詰めました。"
          ],
          funcImg: "",
          techs: [
            ...
            "Vuexによる状態管理を多用しています。",
            "SVG Pathアニメーションの利用。",
            "１．　盤面へのユーザーのクリックを感知すると、そのマス目の座標情報をVuexに対して通知します。",
            "２．　クリックされたマス目に「O」を記入します。",
            "３．　Vuexが現在の盤面情報を受け取り、その盤面を評価します。評価にはテンプレートマッチングを行い、最善手を洗い出します。",
            "４．　O（人間側プレイヤー）にとっての最善手スコアと、X（COM側プレイヤー）にとっての最善手を",
            "５．　"
          ],
          achvs: [
            "<u>Vuexによる状態管理</u>を一通り理解しました。",
            "Vuetifyでの細かいCSS調整がわかりました。",
            "デザインの細かな違いが、サイト全体の印象に相当大きな影響を与えることを実感しました。これは特にゲームや購買サイトなどで顕著だと思います。"
          ]
        },
        {
        ...
        },
        {
          ...
          identifier: "stalker",
          desc:
            "LANを自動スキャンし、<u>接続中デバイスのMACアドレスから各個人を追跡</u>しようとする、性格の悪いプログラムです。ネットワークを勉強する際に、身近なネットワーク機器で何か遊べないか興味が湧いたのでつくりました。",
          ...
          funcs: [
            ...
            "これにより、<u>「どのパソコンが頻繁に使われているのか」「誰がいつ頃在室していたのか」</u>などが推測できます。",
