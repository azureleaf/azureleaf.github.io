      ...
      groups: [
        {
          ...
          skills: [
            ...
            },
            {
              title: "性格",
              desc:
                "抽象的な話ですが、ひとつの物事に没頭して作業を続けられる性格です。これは多くのプログラマに共通するでしょうか。ただし何事もやりすぎては意味がありませんので、他人との関わりの中でこの性格を上手く制御し活かすべきものだと思います。",
            },
            {
              title: "コミュニケーション能力",
              desc:
                "コミュ力が非常に高い人間はたくさんおり、私は及ぶべくもありません。私は理系としては平均くらいではないでしょうか。しかし、プログラミングを勉強する人たちに声をかけて数人で毎週勉強会をやったり、仙台のIT関係の勉強会にあちこち首をつっこんだり、その程度の行動力はあります。「陽キャじゃないけど説明力はとても高い」とは私に対するある人の評。",
            },
            {
              title: "体力",
              desc:
                "仙台周辺の町やら山やら毎日歩いており、体力はある方です。生活の中で運動や気分転換の習慣があることは精神衛生上も役立っています。一日１万から２万歩程度が多いですが、最大だと秋保温泉まで一日45km歩きました。お気に入りの行先は愛子の蕃山。",
            },
            {
              title: "犬",
              desc:
